    ...
    <body>
        <%
            ...
            try{
                ...
                preStm = connect.prepareStatement("UPDATE user SET firstname = ?,lastname = ?,email = ?,gender = ?,address = ?,username = ?,password = ?,priority = ? WHERE IDuser = ?");
